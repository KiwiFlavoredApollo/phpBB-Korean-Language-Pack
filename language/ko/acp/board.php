...
$lang = array_merge($lang, array(
	...
	'ALLOW_SIG_FLASH'			=> '유저 서명안에서 <code>[FLASH]</code> BBCode 태그 사용을 허용',
	'ALLOW_SIG_IMG'				=> '유저 서명안에서 <code>[IMG]</code> BBCode 태그(tag) 사용을 허용',
	'ALLOW_SIG_LINKS'			=> '유저 서명안에서 링크 사용을 허용',
	'ALLOW_SIG_LINKS_EXPLAIN'	=> '만약에 <code>[URL]</code> BBCode 태그와 automatic/magic의 사용이 허용되지 않는다면, URLs 은 사용할 수 없습니다.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_REMOTE_EXPLAIN'			=> '다른 웹사이트에서 링크된 아바타.<br><em><strong class="error">경고:</strong> 이 기능을 활성화하면 사용자가 로컬 네트워크에서만 접근할 수 있는 파일 및 서비스의 존재를 확인할 수 있습니다. .</em>',
	'ALLOW_REMOTE_UPLOAD'			=> '원격 아바타 업로드 활성화',
	'ALLOW_REMOTE_UPLOAD_EXPLAIN'	=> '다른 웹사이트에서 아바타 업로드를 허용합니다.<br><em><strong class="error">경고:</strong> 이 기능을 활성화하면 사용자가 로컬에서만 접근할 수 있는 파일 및 네트워크 서비스의 존재를 확인할 수 있습니다. .</em>',
	...
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'phpBB 루트 디렉토리 아래의 경로, 예: <samp>images/avatars/upload</samp>.<br>아바타 업로드는 이 경로가 쓰기 불가능하면 <strong>사용할 수 없습니다</strong>.<br>이중 점(예를 들어, <samp>..</samp>)은 보안상의 사유로 경로에서 제거됩니다.',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_EXPLAIN'		=> '이것은 사용자가 보드에 즉시 접근할 수 있는지 또는 확인이 필요한지 여부를 결정합니다. 새 등록을 완전히 비활성화할 수도 있습니다. <em>사용자 또는 관리자 활성화를 사용하려면 "게시판 전체 이메일"을 활성화해야 합니다.</em>',
...
$lang = array_merge($lang, array(
	...
	'COOKIE_PATH'				=> '쿠키 경로',
	'COOKIE_PATH_EXPLAIN'		=> '이것은 일반적으로 스크립트 경로와 같거나 사이트 도메인 전체에서 쿠키에 접근할 수 있도록 하기 위한 단순히 슬래시입니다.',
	'COOKIE_SECURE'				=> '쿠키 보안',
...
$lang = array_merge($lang, array(
	...
	'LIMIT_LOAD_EXPLAIN'			=> '시스템의 1분 평균 부하가 이 값을 초과하면 보드가 자동으로 오프라인 상태가 됩니다. 값 1.0은 한 프로세서의 ~100% 사용률과 같습니다. 이것은 UNIX 기반 서버와 이 정보에 접근할 수 있는 곳에서만 작동합니다. 여기서 값은 phpBB가 로드 제한을 얻을 수 없는 경우 0으로 재설정됩니다.',
...
$lang = array_merge($lang, array(
	...
	'LDAP_PASSWORD_EXPLAIN'			=> '익명 바인딩을 사용하려면 공백으로 남겨두고, 그렇지 않으면 위 사용자의 비밀번호를 입력하십시오. Active Directory 서버에 필요합니다.<br><em><strong>경고:</strong> 이 비밀번호는 데이터베이스에 일반 텍스트로 저장되며 데이터베이스에 접근할 수 있거나 이 구성 페이지를 볼 수 있는 모든 사람이 볼 수 있습니다.</em>',
...
$lang = array_merge($lang, array(
	...
	'SMTP_PASSWORD_EXPLAIN'			=> 'SMTP 서버에서 비밀번호를 요구하는 경우에만 비밀번호를 입력하세요.<br><em><strong>경고:</strong> 이 비밀번호는 데이터베이스에 일반 텍스트로 저장되며 데이터베이스에 접근할 수 있거나 볼 수 있는 모든 사람이 볼 수 있습니다. 이 구성 페이지입니다.</em>',
	'SMTP_PLAIN'					=> 'PLAIN',
...
$lang = array_merge($lang, array(
	...
	'JAB_PASSWORD_EXPLAIN'			=> '<em><strong>경고:</strong> 이 비밀번호는 데이터베이스에 일반 텍스트로 저장되며 데이터베이스에 접근할 수 있거나 이 구성 페이지를 볼 수 있는 모든 사람이 볼 수 있습니다.</em>',
	'JAB_PORT'						=> 'Jabber 포트',
