...
// PHP info
$lang = array_merge($lang, array(
	'ACP_PHP_INFO_EXPLAIN'	=> '이 페이지는 이 서버에 설치된 PHP 버전에 대한 정보를 나열합니다. 여기에는 로드된 모듈, 사용 가능한 변수 및 기본 설정에 대한 세부 정보가 포함됩니다. 이 정보는 문제를 진단할 때 유용할 수 있습니다. 일부 호스팅 회사는 보안상의 사유로 여기에 표시되는 정보를 제한할 수 있습니다. 지원 포럼에서 <a href="https://www.phpbb.com/about/team/">공식 모임 구성원</a>이 요청하는 경우를 제외하고 이 페이지에 세부정보를 제공하지 않는 것이 좋습니다.',
